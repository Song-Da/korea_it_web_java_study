...
public class WaterBottle {
    ...
    public void fill(int amount) {
        if (amount > 0 && currentWater + amount <= 1000) {
            ...
            System.out.println("0 이상의 물을 채우지 않거나 물병의 양을 초과할 수 없습니다. 현재 물의 양: " + currentWater);
        }
    }
    ...
    public void drink (int amount) {
        if (amount > 0 && amount <= currentWater) {
            ...
            System.out.println("0 이하의 물을 마시거나 현재 물병의 양을 초과하여 마실 수 없습니다. 현재 물의 양: " + currentWater);
        }
    }
